...
1. The correlation between **restaurant density** and **water main breaks**.
2. The spatial stress on **sanitary pipes and manholes** in high-density food service clusters.

The goal is to identify infrastructure vulnerabilities and inform **targeted compliance strategies** to reduce costly repairs and improve sustainability, aligning with **SDG 6: Clean Water and Sanitation**
